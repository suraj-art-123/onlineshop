...
# validation part
    ...
    if len(password) <3:
        return JsonResponse({'error':'Password needs tobe atleast 3 characters'})
    ...
    try:
        ...
        if  user.check_password(password):
            ...
            if user_session_token !="0":
                user.user_session_token="0"
                user.save()
                return JsonResponse({'error':'prevoious session exist'})
